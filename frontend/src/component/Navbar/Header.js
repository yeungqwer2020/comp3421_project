...
import logo from './petsp_logo.png' ;
    ...
    render() {
        ...
        return (
            <Navbar expand="lg" className="navbar01 " fixed="top">
                <Link to="/home" className="N01" id="Logo" ><img id='Logo-pic' src={logo} alt='Eshop' width='100px' /></Link>
                <Navbar.Toggle aria-controls="responsive-navbar-nav" className="navbar-toggler01"/>
                <Navbar.Collapse id="responsive-navbar-nav">
                    
                        <div className="input-group">
                            <input id="searchKeyword" className="form-control22" type="text" placeholder="Search for products, types and more" aria-label="Search" onSubmit={this.handleSearch}></input>
                            <div className="input-group-prepend">
                                <span><i className="fa fa-search" aria-hidden="true" onClick={this.handleSearch}></i></span>
                            </div>  
                        </div>
                    ...
                    {this.props.userSignin.userInfo && (
                        ...
                        <Link onClick={this.handleLogout} className="login-btn"><Icon.BoxArrowRight size={25} /></Link>
                    )}
